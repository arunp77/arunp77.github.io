/* PrismJS 1.29.0
https://prismjs.com/download.html#themes=prism-okaidia&languages=markup+css+clike+javascript+c+cpp+dax+docker+excel-formula+fortran+git+http+java+json+json5+latex+makefile+markdown+markup-templating+mongodb+php+plsql+powerquery+powershell+python+r+sql */
		...
		tokenize: function (text, grammar) {
			...
			for (var token in rest) {
				if (rest.hasOwnProperty(token)) {
					Object.prototype.hasOwnProperty.call(rest, token) && (grammar[token] = rest[token]);
				}
			}
